...
# Config
apim_gateway = "https://Your API M Name.azure-api.net"
model = "gemini-2.0-flash" #Your Gemini AI Model name
operation = "generateContent"
subscription_key = "Client 2 subscription key goes here"  # Client2
